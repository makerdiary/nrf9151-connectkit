...
LOG_MODULE_REGISTER(uart_bridge, CONFIG_IFMCU_UART_BRIDGE_LOG_LEVEL);

#define RING_BUF_SIZE CONFIG_IFMCU_UART_BRIDGE_BUF_SIZE
				  ...
				  const struct device *bridge_dev)
{
	...
	set_uart_led_state(LED_STATE_BLINK);
