...
4. Press __USR/P25__ button to have a message sent to nRF Cloud:
    ...
    ``` { .txt .no-copy linenums="43" title="Terminal" }
    +CSCON: 0
...
5. After the messages sent, verify that on the nRF Cloud:
    ...
    ![](../../../assets/images/nrf_cloud_coap_device_message.png)
...
[nRF Cloud CoAP Device Message]: https://github.com/makerdiary/nrf9151-connectkit/tree/main/samples/nrf_cloud_coap_device_message
