# nRF Cloud MQTT Cellular Location

## Overview

The nRF Cloud MQTT Cellular Location sample demonstrates how to use the [nRF Cloud MQTT API] for nRF Cloud’s cellular location service on your device.
...
Use the following steps to build the [nRF Cloud MQTT Cellular Location] sample on the command line.
...
3. Build the sample using the `west build` command, specifying the board (following the `-b` option) as `nrf9151_connectkit/nrf9151/ns`.
    ...
    ``` bash
    west build -p always -b nrf9151_connectkit/nrf9151/ns samples/nrf_cloud_mqtt_cell_location
    ```
...
4. After building the sample successfully, the firmware with the name `tfm_merged.hex` can be found in the `build/nrf_cloud_mqtt_cell_location/zephyr` directory.
...
!!! Tip
    ...
    ``` bash
    pyocd load --target nrf91 --frequency 4000000 build/nrf_cloud_mqtt_cell_location/zephyr/tfm_merged.hex
    ```
...
3. Once the device is provisioned and connected, you should see the output, similar to what is shown in the following:
    ...
    [NOT] Built Thu 18 Jun 2026 08:52:11 UTC
    ...
    *** Using Zephyr OS v4.4.0-14033cef1f73 ***
    [00:00:00.259,429] <inf> nrf_cloud_mqtt_cell_location_sample: nRF Cloud MQTT Cellular Location Sample, version: 1.0.0
    [00:00:00.536,468] <inf> nrf_cloud_mqtt_cell_location_sample: Connecting to LTE...
    +CGEV: EXCE STATUS 0
    ...
    [00:01:25.094,421] <inf> nrf_cloud_mqtt_cell_location_sample: Connected to network
    %XTIME: "23","62608180958123","00"
    [00:01:25.094,757] <inf> nrf_cloud_mqtt_cell_location_sample: Waiting for current time
    [00:01:25.129,760] <inf> nrf_cloud_info: Device ID: 5034474b-3731-40ab-809f-152c5c11a9a5
    [00:01:25.131,256] <inf> nrf_cloud_info: IMEI:      359404230074347
    [00:01:25.131,683] <inf> nrf_cloud_info: Modem FW:  mfw_nrf91x1_2.0.4
    [00:01:25.131,713] <inf> nrf_cloud_info: Protocol:          MQTT
    [00:01:25.131,744] <inf> nrf_cloud_info: Download protocol: HTTPS
    [00:01:25.131,774] <inf> nrf_cloud_info: Sec tag:           16842753
    [00:01:25.131,805] <inf> nrf_cloud_info: Host name:         mqtt.nrfcloud.com
    [00:01:35.266,174] <inf> nrf_cloud_mqtt_cell_location_sample: Connection to nRF Cloud ready
    [00:01:35.266,296] <inf> nrf_cloud_mqtt_cell_location_sample: Requesting location with the default configuration...
    [00:01:35.266,632] <inf> nrf_cloud_info: Team ID:   c9bd4aa8-a7e4-4cf1-a273-831d3700c24a
    %NCELLMEAS: 0,"0D70394B","46000","1D23",48,3682,174,47,28,94765,94757
    %NCELLMEAS: 0,"0D70394B","46000","1D23",48,94757,3682,174,47,28,94765,1,0
    %NCELLMEAS: 0,"0D70394B","46000","1D23",48,94757,3682,174,47,28,94765,1,0
    [00:01:36.207,275] <inf> nrf_cloud_mqtt_cell_location_sample: Cellular location request fulfilled with single-cell
    [00:01:36.207,275] <inf> nrf_cloud_mqtt_cell_location_sample: Lat: 22.699996, Lon: 113.927751, Uncertainty: 2498 m
    [00:01:36.207,305] <inf> nrf_cloud_mqtt_cell_location_sample: Google maps URL: https://maps.google.com/?q=22.699996,113.927751
    ```
...
4. After the cell location request sent to nRF Cloud, verify that on the nRF Cloud:
    ...
    ![](../../../assets/images/nrf_cloud_mqtt_cell_location.png)
...
[nRF Cloud MQTT Cellular Location]: https://github.com/makerdiary/nrf9151-connectkit/tree/main/samples/nrf_cloud_mqtt_cell_location
